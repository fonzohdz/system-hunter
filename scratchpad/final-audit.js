...
const LIST=M.EX.map(e=>[e.id, e.id==='squat'
  ? 'CONTROL — the approved reference the rest are read against.' : '']);
...
<h1>Complete library — ${M.EX.length} movements</h1>
<p class="lead">Every movement in the library, animating
